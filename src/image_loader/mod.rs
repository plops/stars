...
impl Default for SyntheticOptions {
    fn default() -> Self {
        ...
        // Generate synthetic bright stars matching real constellations (e.g. Orion / Ursa Major)
        let stars = vec![
            SyntheticStarSpec {
                x: 600.0,
                y: 250.0,
            ...
            SyntheticStarSpec {
                ...
                brightness: 230.0,
                fwhm: 2.4,
                name: Some("Aldebaran".into()),
            },
        ];

        Self {
            name: "synthetic_iphone_orion.jpg".to_string(),
            width,
            height,
